...
const FOIA = {
  ...
  agencies: [
    ...
    { id: "gsa", name: "U.S. General Services Administration", email: null,
      ...
      portalNote: "This button opens PAL (securefoia.gsa.gov), which needs a login.gov sign-in; once in, start a new request and paste the portal version into the description box, with the fee-waiver and expedited justifications in the paste boxes below. Don't want login.gov? File the same text via FOIA.gov's public form (pick General Services Administration) — no account needed, just clunkier — or mail the full letter to the address in the note. GSA correspondence comes from foia@foiaxpress.gsa.gov — safelist it." },
