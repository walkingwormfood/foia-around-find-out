...
const FOIA = {
  ...
  agencies: [
    ...
    { id: "gsa", name: "U.S. General Services Administration", email: null,
      portal: "https://www.foia.gov/",
      submitNote: "GSA's own PAL portal is currently unavailable — its homepage says to submit new requests through FOIA.gov (search \"General Services Administration\" there). Mail also works: FOIA Requester Service Center (LG), 1800 F St NW, Rm 7308, Washington DC 20405; gsa.foia@gsa.gov is for inquiries, not submission. (When PAL returns — securefoia.gsa.gov — it requires a login.gov account. Checked July 2026.)",
      portalNote: "On FOIA.gov: pick General Services Administration as the agency, paste the portal version into the description box, and use the paste boxes below for the fee-waiver and expedited justifications. GSA correspondence comes from foia@foiaxpress.gsa.gov — safelist it and watch spam." },
