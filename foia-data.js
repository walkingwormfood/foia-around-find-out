...
const FOIA = {
  ...
  agencies: [
    ...
    { id: "gsa", name: "U.S. General Services Administration", email: null,
      portal: "https://securefoia.gsa.gov/",
      submitNote: "GSA's Public Access Link (PAL) portal is back up (securefoia.gsa.gov) and is the REQUIRED submission method — GSA's FOIA page states requests \"must be electronically submitted via the PAL application\" or mailed. PAL requires a login.gov sign-in (yes: you need a login.gov account to FOIA about login.gov). No-login alternative: mail the full letter to the FOIA Requester Service Center (LG), 1800 F St NW, Rm 7308, Washington DC 20405. gsa.foia@gsa.gov is for inquiries only, not submission. (Checked July 2026.)",
      portalNote: "PAL (securefoia.gsa.gov) needs a login.gov sign-in; once in, start a new request and paste the portal version into the description box, with the fee-waiver and expedited justifications in the paste boxes below. Prefer no login.gov? Mail the full letter to the address in the note. GSA correspondence comes from foia@foiaxpress.gsa.gov — safelist it." },
